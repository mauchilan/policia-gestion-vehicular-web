...
import { KeycloakAuthzOptions } from '../../models/security/keycloak.authz.options';
import { KeycloakResourcePermission, KeycloakResourcePermissionsCheck } from '../../models/security/keycloak.resource.permission';
import { KeycloakAuthorizationRequest, KeycloakAuthorizationRequestMetaData, ResourcePermission } from '../../models/security/keycloak.authorization.request';
import { KeycloakAuthzInitOptions } from '../../models/security/keycloak.authz.init.options';
...
export class KeycloakAuthorizationService {
  ...
  private hasAuthorization(authorization:KeycloakResourcePermissionsCheck):boolean{
      ...
      if (!t(this._permissions).isEmptyArray){
          ...
          let filteredScope = filteredResource.scopes.find((t: any) => { if (t == checkForScope) return t;});
          //no access to scope
   ...
   */
  public getAuthorizations(resourceServerId: any, authorizationRequest:KeycloakAuthorizationRequest) {
   ...
   */
  private getEntitlement(resourceServerId: any, authorizationRequest:KeycloakAuthorizationRequest) {
